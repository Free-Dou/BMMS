...
<script type="text/javascript" src="JS/httprequestclass.js">
	
</script>
<script type="text/javascript" src="JS/personal_message.js">
	
</script>
<script type="text/javascript" src="JS/common-js.js">
	
</script>
<script type="text/javascript" src="JS/float_window_common.js">
		...
		<%
			...
			if (null == persionMessageList) {		
				...
				for (int i = 0; i < persionMessageList.size(); i++) {
					...
					out.print("<div class=\"message-title\"> " + operationType + " ："
							+ persionMessageObject.getOrderid() + " </div>");
			...
			/* 
					...
					for (int j = i; j < persionMessageList.size(); j++) {
						...
						if (persionMessageObject.getOrderid().equals(orderid)) {
							...
							out.print("<div id=\"final_cell_0\" class=\"table-cell-" + ((columnNo % 2) + 1)
									+ "\" style=\"width: 8%;\"> </div>");
							out.print("<div id=\"final_cell_1\" class=\"table-cell-" + ((columnNo % 2) + 1)
									+ "\" style=\"width: 20%;\">" + persionMessageObject.getMpspec() + "</div>");
							out.print("<div id=\"final_cell_2\" class=\"table-cell-" + ((columnNo % 2) + 1)
									+ "\" style=\"width: 20%;\">" + persionMessageObject.getMname() + "</div>");
							out.print("<div id=\"final_cell_2\" class=\"table-cell-" + ((columnNo % 2) + 1)
									+ "\" style=\"width: 8%;\">"
									+ String.format("%.3f", persionMessageObject.getNumber()) + "</div>");
							out.print("<div id=\"final_cell_2\" class=\"table-cell-" + ((columnNo % 2) + 1)
									+ "\" style=\"width: 8%;\">"
									+ String.format("%.2f", persionMessageObject.getPrice()) + "¥</div>");
							out.print("<div id=\"final_cell_2\" class=\"table-cell-" + ((columnNo % 2) + 1)
									+ "\" style=\"width: 8%;\">"
									+ String.format("%.2f", persionMessageObject.getTotalPrice()) + "¥</div>");
							out.print("<div id=\"final_cell_2\" class=\"table-cell-" + ((columnNo % 2) + 1)
									+ "\" style=\"width: 25%;\">" + persionMessageObject.getRemark() + "</div>");
							out.print("</div>");
					...
					out.print("<div class=\"table-line\" style=\"margin-left: 0px;\">");
					out.print("<div id=\"final_cell_0\" class=\"table-cell-" + ((columnNo % 2) + 1)
							+ "\" style=\"width: 8%;\">合计</div>");
					out.print("<div id=\"final_cell_1\" class=\"table-cell-" + ((columnNo % 2) + 1)
							+ "\" style=\"width: 20%;\">/</div>");
					out.print("<div id=\"final_cell_2\" class=\"table-cell-" + ((columnNo % 2) + 1)
							+ "\" style=\"width: 20%;\">/</div>");
					out.print("<div id=\"final_cell_3\" class=\"table-cell-" + ((columnNo % 2) + 1)
							+ "\" style=\"width: 8%;\">" + String.format("%.3f", productTotalNum) + "</div>");
					out.print("<div id=\"final_cell_4\" class=\"table-cell-" + ((columnNo % 2) + 1)
							+ "\" style=\"width: 8%;\">/</div>");
					out.print("<div id=\"final_cell_5\" class=\"table-cell-" + ((columnNo % 2) + 1)
							+ "\" style=\"width: 8%;\">" + String.format("%.2f", allProductTotalPrice) + "¥</div>");
					out.print("<div id=\"final_cell_6\" class=\"table-cell-" + ((columnNo % 2) + 1)
							+ "\" style=\"width: 25%;\">／</div>");
					out.print("</div>");
					out.print("</div>");
					...
					out.print("</div>");
					out.print("</div>");
					out.print("<div class=\"message-time\"> User:" + persionMessageObject.getUsername() + " Time:"
							+ persionMessageObject.getCreateTime() + " </div>");
					...
					if (1 == userGrade) {
						...
						if (persionMessageObject.getApproval().equals("0")) { /* 未审核订单 */
							...
							out.print("<div id=\"cancle_button" + persionMessageObject.getOrderid()
									+ "\" class=\"red_button\" style=\"margin-right: 34px;\"onmouseenter=\""
									+ "button_mouseenter('cancle_button" + persionMessageObject.getOrderid()
									+ "')\" onmouseleave=\"button_mouseleave('cancle_button"
									+ persionMessageObject.getOrderid() + "')\" "
									+ "onmousedown=\"button_mousedown('cancle_button"
									+ persionMessageObject.getOrderid()
									+ "')\" onmouseup=\"button_mouseup('cancle_button"
									+ persionMessageObject.getOrderid() + "')\" " + "onclick=\"cancle_click('"
									+ persionMessageObject.getOrderid() + "')\">");
							out.print("<p style=\"top: 50%; transform: translateY(-50%);\">打回</p>");
							out.print("</div>");
							out.print("<div id=\"confirm_button" + persionMessageObject.getOrderid()
									+ "\" class=\"blue_button\" style=\"margin-right: 10px;\" onmouseenter=\""
									+ "button_mouseenter('confirm_button" + persionMessageObject.getOrderid()
									+ "')\" onmouseleave=\"button_mouseleave('confirm_button"
									+ persionMessageObject.getOrderid() + "')\" "
									+ "onmousedown=\"button_mousedown('confirm_button"
									+ persionMessageObject.getOrderid()
									+ "')\" onmouseup=\"button_mouseup('confirm_button"
									+ persionMessageObject.getOrderid() + "')\"" + " onclick=\"confirm_click('"
									+ persionMessageObject.getOrderid() + "')\">");
