				...
				<%
					...
					if (null != projectQunatityList){
						for (int i = 0; i < projectQunatityList.size(); i++){
							...
							out.print("<div onclick=\"reedit_click('" + projectQunatityObject.getProjectID() + "')\" class=\"table-cell-" + ((i % 2) + 1) + "\" style=\"width: 5%; cursor: pointer;\"> <img src=\"IMG/add.png\" class=\"footer-button-img\"> </div>");
							out.print("</div>");
						}
					}
				%>
