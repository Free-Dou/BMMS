	...
	<head>
		...
		<div id="orderation_info_pad" class="right-page-contains">
			...
			<dir class="page-footer main-page-footer">
				<div class="footer-button" id="buyinfo_footer_button_1" onmouseenter="button_mouseenter_footer('buyinfo_footer_button_1')" onmouseleave="button_mouseleave_footer('buyinfo_footer_button_1')" onmousedown="button_mousedown_footer('buyinfo_footer_button_1')" onmouseup="button_mouseup_footer('buyinfo_footer_button_1')" onclick="add_click('orderation_info_pad', 'add_window')">
		...
		<div id="add_window" class="new_float_window">
			<div class="set_center" style="height: 300px; width: 400px;">
				...
				<form action="/BMMS/AddSupplierInfo" method="post" id="form_post">
					...
					<div id="cancle_button" class="red_button" style="margin-right: 54px;" onmouseenter="button_mouseenter('cancle_button')" onmouseleave="button_mouseleave('cancle_button')" onmousedown="button_mousedown('cancle_button')" onmouseup="button_mouseup('cancle_button')" onclick="cancle_click('orderation_info_pad', 'add_window')">
