...
public class AddProjectQunatityBatchServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if ((null != reqParams) && (!reqParams.equals(""))){
			try {
				...
				String eachBatch = jsonObject.getString("eachBatch");
				Long price = jsonObject.getLong("price");
				String picLoca = jsonObject.getString("picLoca");
				String remark = "NULL";
				
				ProjectQunatityBatch qunatityBatchObject = new ProjectQunatityBatch(projectID, eachBatch, price.floatValue(), picLoca, remark);
				
				qunatityBatchObject.addQunatityBatchToDB();
				logger.info("[AddProjectQunatityBatchServlet.java:doPost] Create Project QunatityBatch Object By post-order json success!!!");
			} catch (JSONException e) {
				logger.error("[AddProjectQunatityBatchServlet.java:doPost] Create Project QunatityBatch Object By post-order json Failed!!! jsonData = " + reqParams);
